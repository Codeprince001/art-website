    ...
    <>
      <div className=' flex flex-col centre pt-4'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='pb-4'>
            <input type='email' required placeholder='email' className='pr-[150px] pl-4 py-6 rounded-full md:w-[80%] w-full' />
          </div>
          <div>

            <Link><button className='w-full lg:w-[40%] bg-gradient-to-br from-[#EA6EE7] via-[#AB54FD] to-[#7D2AE7] text-white rounded-[30px] py-6 font-semibold mb-8 text-center'>
              submit</button></Link>
          </div>
        </div>
