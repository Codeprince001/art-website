...
const Navbar = () => {
  ...
  return (
    <div >
      <div className="md:flex flex justify-between p-4 flex-1 relative md:items-center md:flex-1 md:justify-between md:py-[25px] md:pr-[60px] bg-[#F3F3F3] md:pl-[60px] ">
        ...
        <div className={`md:flex lg:flex-row flex-col lg:items-center text-[#1E0734] absolute top-24 lg:static ${mobileMenuOpen ? 'z-50' : 'z-[-1]'} lg:z-[50] left-0 w-full lg:w-auto bg-[#F3F3F3]`}>
          {links.map((item) => {
            return (
              <NavLink key={item.name} to={item.to} className="text-[#1E0734] font-bold mr-8">
